                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a type="button" class="btn btn-sm btn-secondary"
                                    href="?editTickets=<?=$tickets['id_Tickets']?>">Modifier</a></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
                ...
                <?php foreach ($listTickets as $index => $tickets):?>
                    <div class="form-row">
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control form-control-sm" name="priceTicket"
                                id="priceTicket" value="<?=$tickets['price_Tickets']?>" />
                        </div>
                        <div class="form-group col-8">
                            <label for="typesTicket">Types d'Offre</label>
                            <input type="text" class="form-control form-control-sm" name="typesTicket"
                                id="typesTicket" value="<?=$tickets['type_Tickets']?>" />
                        </div>
                    </div>
                    <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-2">
                        ...
                        <input type="time" class="form-control form-control-sm" name="durationShow" id="durationShow"
                            value="<?=date('H:i', strtotime($ShowManager->getDuration_Shows()))?>" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-6">
                        <label for="titleShow">Titre</label>
                        <input type="text" class="form-control form-control-sm" name="titleShow" id="titleShow"
                            value="<?=$ShowManager->getTitle_Shows()?>" />
                    </div>
                    <div class="form-group col-6">
                        <label for="performerShow">Artiste</label>
                        <input type="text" class="form-control form-control-sm" name="performerShow" id="performerShow"
                            value="<?=$ShowManager->getPerformer_Shows()?>" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-6">
                        ...
                        <input type="date" class="form-control" name="dateShow" id="dateShow"
                            value="<?=date('Y-m-d', strtotime($ShowManager->getDateHour_Shows()))?>" />
                    </div>
                    <div class="form-group col-6">
                        <label for="hourShow">Heure</label>
                        <input type="time" class="form-control" name="hourShow" id="hourShow"
                            value="<?=date('H:i', strtotime($ShowManager->getDateHour_Shows()))?>" />
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-6">
                        ...
                        <select class="custom-select" name="showTypes" id="showTypes">
                            ...
                            <option
                                <?=$ShowManager->getId_ShowTypes() == $showTypes['types_ShowTypes'] ? 'selected' : ''?>
                                value="<?=$showTypes['id_ShowTypes']?>"><?=$showTypes['types_ShowTypes']?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    <div class="form-group col-6">
                        ...
                        <select class="custom-select" name="genreShow" id="genreShow">
                            ...
                            <option <?=$ShowManager->getId_Genres() == $genres['name_Genres'] ? 'selected' : ''?>
                                value="<?=$genres['id_Genres']?>"><?=$genres['name_Genres']?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
                <div class="form-row justify-content-center">
                    <div class="form-group col-6">
                        <button type="submit" class="btn btn-sm btn-block btn-outline-dark"
                            name="confirmUpdateShow">Valider</button>
                    </div>
                </div>
            </form>
        </div>
